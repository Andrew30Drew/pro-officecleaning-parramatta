...
export const metadata: Metadata = {
  title: 'Commercial Cleaning Artarmon NSW | Professional Business Cleaning Services',
  description: 'Top-rated commercial cleaning services in Artarmon NSW. Professional business cleaning for offices, retail, warehouses & commercial facilities. Expert teams, competitive rates.',
  keywords: 'commercial cleaning Artarmon, commercial cleaners Artarmon, business cleaning Artarmon, professional office cleaning Artarmon, office cleaning services Artarmon, corporate cleaning Artarmon, strata cleaning Artarmon, industrial cleaning Artarmon, warehouse cleaning Artarmon, retail cleaning services Artarmon, medical centre cleaning Artarmon, childcare centre cleaning Artarmon, gym cleaning Artarmon, school cleaning Artarmon, church cleaning Artarmon, professional strata cleaners Artarmon, commercial cleaning companies Artarmon, office cleaning company Artarmon, janitorial services Artarmon, commercial building cleaning Artarmon',
  openGraph: {
    title: 'Commercial Cleaning Artarmon NSW | Professional Business Cleaning Services',
    description: 'Top-rated commercial cleaning services in Artarmon NSW. Professional business cleaning for offices, retail, warehouses & commercial facilities. Expert teams, competitive rates.',
    url: '/commercial-cleaning-artarmon',
    type: 'website',
    images: [{ url: '/meta.png', alt: 'Commercial cleaning Artarmon NSW' }]
  },
  alternates: { canonical: '/commercial-cleaning-artarmon' }
};
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <p className="text-xl mb-8 text-gray-100">
                Top-rated commercial cleaning services for all business types across Artarmon NSW. Professional cleaning solutions for offices, retail stores, warehouses, and commercial facilities with expert teams and competitive rates.
              </p>
            </div>
            <div className="relative">
              <Image
                src="/images/services/commercial.webp"
                alt="Commercial cleaning Artarmon NSW - Professional business cleaning services"
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-12">
              ...
              <div>
                <Image
                  ...
                  alt="Professional commercial cleaning team Artarmon NSW"
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-12">
              <div>
                ...
                alt="Clean commercial facility Artarmon NSW"
                className="rounded-xl shadow-lg w-full h-64 object-cover mb-6"
                width={400}
                height={256}
                loading="lazy"
            ...
            <p className="text-gray-700 mb-6 text-lg">
              Pro Clean Corp provides commercial cleaning services throughout Artarmon NSW and surrounding areas. Our commercial cleaning teams service businesses in:
            </p>
            ...
            <h3 className="text-2xl font-bold text-darkblue mb-6">Frequently Asked Questions about Commercial Cleaning in Artarmon</h3>
            <div className="space-y-6 mb-12">
              {[
                {
                  question: 'What types of commercial properties do you clean in Artarmon NSW?',
                  answer: 'We provide comprehensive commercial cleaning services for a wide range of properties in Artarmon, including corporate offices, retail showrooms, warehouses, industrial facilities, strata buildings, medical centres, gyms, schools, and childcare centres. Our team is equipped to handle the specific cleaning requirements of any business environment in the Artarmon area.'
                },
                {
                  question: 'How much does commercial cleaning cost in Artarmon?',
                  answer: 'Commercial cleaning rates in Artarmon vary depending on the size of your facility, the frequency of service, and your specific cleaning needs. Typically, our rates range from $35 to $60 per hour. We offer free, no-obligation quotes and can customize a cleaning package to suit your budget and requirements.'
                },
                {
                  question: 'Do you offer after-hours office cleaning in Artarmon?',
                  answer: 'Yes, we understand that businesses in Artarmon need to operate without disruption. We offer flexible scheduling, including after-hours, early mornings, and weekends, to ensure your workplace is cleaned at a time that minimizes impact on your daily operations.'
                },
                {
                  question: 'Are your Artarmon commercial cleaners insured and background checked?',
                ...
                {
                  question: 'Can you provide strata and body corporate cleaning in Artarmon?',
                  answer: 'Yes, we specialize in strata and body corporate cleaning for residential and commercial complexes in Artarmon. Our services include common area maintenance, foyer cleaning, lift sanitization, bin management, and garden maintenance, ensuring your property is always well-presented for residents and visitors.'
                }
              ].map((faq, index) => (
            ...
            <div className="bg-gradient-to-r from-blueprimary to-darkblue rounded-2xl p-8 text-white text-center">
              <h3 className="text-3xl font-bold mb-4">Professional Commercial Cleaning Artarmon NSW</h3>
