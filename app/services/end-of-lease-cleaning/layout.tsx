...
export const metadata: Metadata = {
  title: 'End of Lease Cleaning Services Sydney NSW - Pro Clean Corp Professional Cleaners',
  description:
    'Professional End of Lease Cleaning services in Sydney NSW by Pro Clean Corp. Office cleaning, industrial cleaning, retail cleaning, warehouse cleaning, and specialized commercial property maintenance. Trusted local cleaners serving Sydney NSW businesses.',
  keywords: [
    'End of Lease Cleaning services Sydney NSW',
  ...
  authors: [{ name: 'Pro Clean Corp End of Lease Cleaning Services Sydney NSW' }],
  creator: 'Pro Clean Corp End of Lease Cleaning Services Sydney NSW',
  publisher: 'Pro Clean Corp End of Lease Cleaning Services Sydney NSW',
  ...
  openGraph: {
    ...
    title: 'End of Lease Cleaning Services Sydney NSW - Pro Clean Corp Professional Cleaners',
    description:
      'Professional End of Lease Cleaning services in Sydney NSW by Pro Clean Corp. Office cleaning, industrial cleaning, retail cleaning, and specialized commercial property maintenance.',
    siteName: 'Pro Clean Corp End of Lease Cleaning Services Sydney NSW',
    images: [
      {
        url: 'https://www.procleancorp.com.au/meta.png',
        width: 1200,
        height: 630,
        alt: 'Pro Clean Corp End of Lease Cleaning Services Sydney NSW - Professional Office and Industrial Cleaners',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'End of Lease Cleaning Services Sydney NSW - Pro Clean Corp',
    description:
      'Professional End of Lease Cleaning services in Sydney NSW. Office cleaning, industrial cleaning, retail cleaning, and specialized commercial property maintenance.',
