...
export const metadata: Metadata = {
  title: 'Home Cleaning Services Sydney NSW - Pro Clean Corp Professional Cleaners',
  description:
    'Professional Home Cleaning services in Sydney NSW by Pro Clean Corp. Office cleaning, industrial cleaning, retail cleaning, warehouse cleaning, and specialized commercial property maintenance. Trusted local cleaners serving Sydney NSW businesses.',
  keywords: [
    'Home Cleaning services Sydney NSW',
  ...
  authors: [{ name: 'Pro Clean Corp Home Cleaning Services Sydney NSW' }],
  creator: 'Pro Clean Corp Home Cleaning Services Sydney NSW',
  publisher: 'Pro Clean Corp Home Cleaning Services Sydney NSW',
  category: 'Home Cleaning Services',
  metadataBase: new URL('https://www.procleancorp.com.au'),
  alternates: {
    canonical: '/services/home-cleaning',
  },
  openGraph: {
    type: 'website',
    locale: 'en_AU',
    ...
    title: 'Home Cleaning Services Sydney NSW - Pro Clean Corp Professional Cleaners',
    description:
      'Professional Home Cleaning services in Sydney NSW by Pro Clean Corp. Office cleaning, industrial cleaning, retail cleaning, and specialized commercial property maintenance.',
    siteName: 'Pro Clean Corp Home Cleaning Services Sydney NSW',
    images: [
      {
        url: 'https://www.procleancorp.com.au/meta.png',
        width: 1200,
        height: 630,
        alt: 'Pro Clean Corp Home Cleaning Services Sydney NSW - Professional Office and Industrial Cleaners',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Home Cleaning Services Sydney NSW - Pro Clean Corp',
    description:
      'Professional Home Cleaning services in Sydney NSW. Office cleaning, industrial cleaning, retail cleaning, and specialized commercial property maintenance.',
