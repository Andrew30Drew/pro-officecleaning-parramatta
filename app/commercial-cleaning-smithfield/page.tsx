...
export const metadata: Metadata = {
  title: 'Commercial Cleaning Smithfield NSW | Professional Business Cleaning Services',
  description: 'Top-rated commercial cleaning services in Smithfield NSW. Professional business cleaning for offices, retail, warehouses & commercial facilities. Expert teams, competitive rates.',
  keywords: 'commercial cleaning Smithfield, commercial cleaners Smithfield, business cleaning Smithfield, professional office cleaning Smithfield, office cleaning services Smithfield, corporate cleaning Smithfield, strata cleaning Smithfield, industrial cleaning Smithfield, warehouse cleaning Smithfield, retail cleaning services Smithfield, medical centre cleaning Smithfield, childcare centre cleaning Smithfield, gym cleaning Smithfield, school cleaning Smithfield, church cleaning Smithfield, professional strata cleaners Smithfield, commercial cleaning companies Smithfield, office cleaning company Smithfield, janitorial services Smithfield, commercial building cleaning Smithfield',
  openGraph: {
    title: 'Commercial Cleaning Smithfield NSW | Professional Business Cleaning Services',
    description: 'Top-rated commercial cleaning services in Smithfield NSW. Professional business cleaning for offices, retail, warehouses & commercial facilities. Expert teams, competitive rates.',
    url: '/commercial-cleaning-smithfield',
    type: 'website',
    images: [{ url: '/meta.png', alt: 'Commercial cleaning Smithfield NSW' }]
  },
  alternates: { canonical: '/commercial-cleaning-smithfield' }
};
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
                Commercial Cleaning Smithfield NSW
              </h1>
              <p className="text-xl mb-8 text-gray-100">
                Top-rated commercial cleaning services for all business types across Smithfield NSW. Professional cleaning solutions for offices, retail stores, warehouses, and commercial facilities with expert teams and competitive rates.
              </p>
            </div>
            <div className="relative">
              <Image
                src="/images/services/commercial.webp"
                alt="Commercial cleaning Smithfield NSW - Professional business cleaning services"
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-12">
              ...
              <div>
                <Image
                  ...
                  alt="Professional commercial cleaning team Smithfield NSW"
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-12">
              <div>
                ...
                alt="Clean commercial facility Smithfield NSW"
                className="rounded-xl shadow-lg w-full h-64 object-cover mb-6"
                width={400}
                height={256}
                loading="lazy"
            ...
            <p className="text-gray-700 mb-6 text-lg">
              Pro Clean Corp provides commercial cleaning services throughout Smithfield NSW and surrounding areas. Our commercial cleaning teams service businesses in:
            </p>
            ...
            <h3 className="text-2xl font-bold text-darkblue mb-6">Frequently Asked Questions about Commercial Cleaning in Smithfield</h3>
            <div className="space-y-6 mb-12">
              {[
                {
                  question: 'What types of commercial properties do you clean in Smithfield NSW?',
                  answer: 'We provide comprehensive commercial cleaning services for a wide range of properties in Smithfield, including corporate offices, retail showrooms, warehouses, industrial facilities, strata buildings, medical centres, gyms, schools, and childcare centres. Our team is equipped to handle the specific cleaning requirements of any business environment in the Smithfield area.'
                },
                {
                  question: 'How much does commercial cleaning cost in Smithfield?',
                ...
                {
                  question: 'Do you offer after-hours office cleaning in Smithfield?',
                  answer: 'Yes, we understand that businesses in Smithfield need to operate without disruption. We offer flexible scheduling, including after-hours, early mornings, and weekends, to ensure your workplace is cleaned at a time that minimizes impact on your daily operations.'
                },
                {
                  question: 'Are your Smithfield commercial cleaners insured and background checked?',
                  answer: 'Absolutely. All our commercial cleaning staff servicing Smithfield are fully insured with public liability coverage, have undergone strict police background checks, and are rigorously trained in WHS and industry-standard cleaning protocols. You can trust our team to be professional, reliable, and secure.'
                },
                {
                  question: 'Can you provide strata and body corporate cleaning in Smithfield?',
                  answer: 'Yes, we specialize in strata and body corporate cleaning for residential and commercial complexes in Smithfield. Our services include common area maintenance, foyer cleaning, lift sanitization, bin management, and garden maintenance, ensuring your property is always well-presented for residents and visitors.'
                }
              ].map((faq, index) => (
            ...
            <div className="bg-gradient-to-r from-blueprimary to-darkblue rounded-2xl p-8 text-white text-center">
              <h3 className="text-3xl font-bold mb-4">Professional Commercial Cleaning Smithfield NSW</h3>
