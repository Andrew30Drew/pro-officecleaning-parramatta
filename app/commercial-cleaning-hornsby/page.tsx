...
export const metadata: Metadata = {
  title: 'Commercial Cleaning Hornsby NSW | Professional Business Cleaning Services',
  description: 'Top-rated commercial cleaning services in Hornsby NSW. Professional business cleaning for offices, retail, warehouses & commercial facilities. Expert teams, competitive rates.',
  keywords: 'commercial cleaning Hornsby, commercial cleaners Hornsby, business cleaning Hornsby, professional office cleaning Hornsby, office cleaning services Hornsby, corporate cleaning Hornsby, strata cleaning Hornsby, industrial cleaning Hornsby, warehouse cleaning Hornsby, retail cleaning services Hornsby, medical centre cleaning Hornsby, childcare centre cleaning Hornsby, gym cleaning Hornsby, school cleaning Hornsby, church cleaning Hornsby, professional strata cleaners Hornsby, commercial cleaning companies Hornsby, office cleaning company Hornsby, janitorial services Hornsby, commercial building cleaning Hornsby',
  openGraph: {
    title: 'Commercial Cleaning Hornsby NSW | Professional Business Cleaning Services',
    description: 'Top-rated commercial cleaning services in Hornsby NSW. Professional business cleaning for offices, retail, warehouses & commercial facilities. Expert teams, competitive rates.',
    url: '/commercial-cleaning-hornsby',
    type: 'website',
    images: [{ url: '/meta.png', alt: 'Commercial cleaning Hornsby NSW' }]
  },
  alternates: { canonical: '/commercial-cleaning-hornsby' }
};

export default function CommercialCleaningPage() {
  const faqs = [
    {
      question: 'What types of commercial properties do you clean in Hornsby NSW?',
      answer: 'We provide comprehensive commercial cleaning services for a wide range of properties in Hornsby, including corporate offices, retail showrooms, warehouses, industrial facilities, strata buildings, medical centres, gyms, schools, and childcare centres. Our team is equipped to handle the specific cleaning requirements of any business environment in the Hornsby area.'
    },
    {
      question: 'How much does commercial cleaning cost in Hornsby?',
      answer: 'Commercial cleaning rates in Hornsby vary depending on the size of your facility, the frequency of service, and your specific cleaning needs. Typically, our rates range from $35 to $60 per hour. We offer free, no-obligation quotes and can customize a cleaning package to suit your budget and requirements.'
    },
    {
      question: 'Do you offer after-hours office cleaning in Hornsby?',
      answer: 'Yes, we understand that businesses in Hornsby need to operate without disruption. We offer flexible scheduling, including after-hours, early mornings, and weekends, to ensure your workplace is cleaned at a time that minimizes impact on your daily operations.'
    },
    {
      question: 'Are your Hornsby commercial cleaners insured and background checked?',
    ...
    {
      question: 'Can you provide strata and body corporate cleaning in Hornsby?',
      answer: 'Yes, we specialize in strata and body corporate cleaning for residential and commercial complexes in Hornsby. Our services include common area maintenance, foyer cleaning, lift sanitization, bin management, and garden maintenance, ensuring your property is always well-presented for residents and visitors.'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      <ServiceStructuredData
        serviceName="Commercial Cleaning Hornsby NSW"
        serviceDescription="Top-rated commercial cleaning services in Hornsby NSW. Professional business cleaning for offices, retail, warehouses & commercial facilities."
        serviceUrl="/commercial-cleaning-hornsby"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
                Commercial Cleaning Hornsby NSW
              </h1>
              <p className="text-xl mb-8 text-gray-100">
                Top-rated commercial cleaning services for all business types across Hornsby NSW. Professional cleaning solutions for offices, retail stores, warehouses, and commercial facilities with expert teams and competitive rates.
              </p>
            </div>
            <div className="relative">
              <Image
                src="/images/services/commercial.webp"
                alt="Commercial cleaning Hornsby NSW - Professional business cleaning services"
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-12">
              ...
              <div>
                <Image
                  ...
                  alt="Professional commercial cleaning team Hornsby NSW"
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-12">
              <div>
                ...
                alt="Clean commercial facility Hornsby NSW"
                className="rounded-xl shadow-lg w-full h-64 object-cover mb-6"
                width={400}
                height={256}
                loading="lazy"
            ...
            <p className="text-gray-700 mb-6 text-lg">
              Pro Clean Corp provides commercial cleaning services throughout Hornsby NSW and surrounding areas. Our commercial cleaning teams service businesses in:
            </p>
            ...
            <h3 className="text-2xl font-bold text-darkblue mb-6">Frequently Asked Questions about Commercial Cleaning in Hornsby</h3>
            ...
            <div className="bg-gradient-to-r from-blueprimary to-darkblue rounded-2xl p-8 text-white text-center">
              <h3 className="text-3xl font-bold mb-4">Professional Commercial Cleaning Hornsby NSW</h3>
