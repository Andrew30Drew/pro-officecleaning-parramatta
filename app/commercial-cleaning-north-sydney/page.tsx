...
export const metadata: Metadata = {
  title: 'Commercial Cleaning North Sydney NSW | Professional Business Cleaning Services',
  description: 'Top-rated commercial cleaning services in North Sydney NSW. Professional business cleaning for offices, retail, warehouses & commercial facilities. Expert teams, competitive rates.',
  keywords: 'commercial cleaning North Sydney, commercial cleaners North Sydney, business cleaning North Sydney, professional office cleaning North Sydney, office cleaning services North Sydney, corporate cleaning North Sydney, strata cleaning North Sydney, industrial cleaning North Sydney, warehouse cleaning North Sydney, retail cleaning services North Sydney, medical centre cleaning North Sydney, childcare centre cleaning North Sydney, gym cleaning North Sydney, school cleaning North Sydney, church cleaning North Sydney, professional strata cleaners North Sydney, commercial cleaning companies North Sydney, office cleaning company North Sydney, janitorial services North Sydney, commercial building cleaning North Sydney',
  openGraph: {
    title: 'Commercial Cleaning North Sydney NSW | Professional Business Cleaning Services',
    description: 'Top-rated commercial cleaning services in North Sydney NSW. Professional business cleaning for offices, retail, warehouses & commercial facilities. Expert teams, competitive rates.',
    url: '/commercial-cleaning-north-sydney',
    type: 'website',
    images: [{ url: '/meta.png', alt: 'Commercial cleaning North Sydney NSW' }]
  },
  alternates: { canonical: '/commercial-cleaning-north-sydney' }
};
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
                Commercial Cleaning North Sydney NSW
              </h1>
              <p className="text-xl mb-8 text-gray-100">
                Top-rated commercial cleaning services for all business types across North Sydney NSW. Professional cleaning solutions for offices, retail stores, warehouses, and commercial facilities with expert teams and competitive rates.
              </p>
            </div>
            <div className="relative">
              <Image
                src="/images/services/commercial.webp"
                alt="Commercial cleaning North Sydney NSW - Professional business cleaning services"
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-12">
              ...
              <div>
                <Image
                  ...
                  alt="Professional commercial cleaning team North Sydney NSW"
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-12">
              <div>
                ...
                alt="Clean commercial facility North Sydney NSW"
                className="rounded-xl shadow-lg w-full h-64 object-cover mb-6"
                width={400}
                height={256}
                loading="lazy"
            ...
            <p className="text-gray-700 mb-6 text-lg">
              Pro Clean Corp provides commercial cleaning services throughout North Sydney NSW and surrounding areas. Our commercial cleaning teams service businesses in:
            </p>
            ...
            <h3 className="text-2xl font-bold text-darkblue mb-6">Frequently Asked Questions about Commercial Cleaning in North Sydney</h3>
            <div className="space-y-6 mb-12">
              {[
                {
                  question: 'What types of commercial properties do you clean in North Sydney NSW?',
                  answer: 'We provide comprehensive commercial cleaning services for a wide range of properties in North Sydney, including corporate offices, retail showrooms, warehouses, industrial facilities, strata buildings, medical centres, gyms, schools, and childcare centres. Our team is equipped to handle the specific cleaning requirements of any business environment in the North Sydney area.'
                },
                {
                  question: 'How much does commercial cleaning cost in North Sydney?',
                  answer: 'Commercial cleaning rates in North Sydney vary depending on the size of your facility, the frequency of service, and your specific cleaning needs. Typically, our rates range from $35 to $60 per hour. We offer free, no-obligation quotes and can customize a cleaning package to suit your budget and requirements.'
                },
                {
                  question: 'Do you offer after-hours office cleaning in North Sydney?',
                  answer: 'Yes, we understand that businesses in North Sydney need to operate without disruption. We offer flexible scheduling, including after-hours, early mornings, and weekends, to ensure your workplace is cleaned at a time that minimizes impact on your daily operations.'
                },
                {
                  question: 'Are your North Sydney commercial cleaners insured and background checked?',
                  answer: 'Absolutely. All our commercial cleaning staff servicing North Sydney are fully insured with public liability coverage, have undergone strict police background checks, and are rigorously trained in WHS and industry-standard cleaning protocols. You can trust our team to be professional, reliable, and secure.'
                },
                {
                  question: 'Can you provide strata and body corporate cleaning in North Sydney?',
                  answer: 'Yes, we specialize in strata and body corporate cleaning for residential and commercial complexes in North Sydney. Our services include common area maintenance, foyer cleaning, lift sanitization, bin management, and garden maintenance, ensuring your property is always well-presented for residents and visitors.'
                }
              ].map((faq, index) => (
            ...
            <div className="bg-gradient-to-r from-blueprimary to-darkblue rounded-2xl p-8 text-white text-center">
              <h3 className="text-3xl font-bold mb-4">Professional Commercial Cleaning North Sydney NSW</h3>
